...
<jsp:attribute name="scriptsEspecificos">
	<script type="text/javascript">
		function remover(id,row) {
			swal({   
				...
				function(){   
					var destino = '<c:url value="/cargos/delete/"/>' + id;
					$.ajax({
						type : 'POST',
						url : destino,
	...
	<jsp:body>
		<section class="wrapper">
			...
			<a class="btn btn-primary" href="<c:url value="/cargos/form"/>" 
